...
#include "component_event_hook.hpp"
...
public:
    ...
    /**
    * @brief The manager responsible for reactive component callbacks.
    */
    ComponentEventHook event_hook;

    /**
     * @brief The fluent API manager for looping through filtered entities.
     */
